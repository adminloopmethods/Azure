...
import AzureLogo from "@/assets/icons/azure-logo-2.svg";
...
//     <circle opacity="0.2" cx="19.6847" cy="19.6847" r="19.1847" fill="#BDBDBD" stroke="black" />
//     <circle cx="20.2995" cy="19.069" r="9.22722" fill="url(#paint0_linear_406_372)" />
//     <defs>
//       <linearGradient id="paint0_linear_406_372" x1="20.2995" y1="9.8418" x2="20.2995" y2="28.2962" gradientUnits="userSpaceOnUse">
...
const ContactSection = () => {
  ...
  const position = { lat: 28.633165572626655, lng: 77.13850344072142 };
  ...
  const contactDetails = [
    ...
    },
    {
      icon: <PhoneIcon />,
      title: "Call us",
      details: ["+91-98111-53334", "+91-98991-06357"],
    },
    {
      icon: <LocationIcon />,
      title: "Find us",
          ...
          {contactDetails.map((item, index) => (
            <React.Fragment key={item.title}>
              ...
              {item.details.map((line, lineIndex) => (
                <div
                  key={lineIndex}
                  className={`ml-8 max-md:ml-0 text-lg max-md:text-sm font-light text-white ${
                    item.title === "Find us" && lineIndex === 0
                      ? "mb-1.5 leading-7 max-w-[357px]"
                      : "mb-2.5 leading-6"
                  }`}
                >
                  {line}
      ...
      <div>
        ...
        >
          <APIProvider apiKey={process.env.NEXT_PUBLIC_GOOGLE_MAPS_NEW_API_KEY}>
            <Map
              ...
              defaultZoom={18}
              mapId="YOUR_ACTUAL_MAP_ID_HERE" // Replace with real ID from Google Console
            >
              <AdvancedMarker position={position} title={"Azure Innovations"}>
                <Pin
                  background={"#000"}
                  glyphColor={"#fff"}
                  borderColor={"#000"}
              ...
              <InfoWindow
                ...
                disableAutoPan={true}
              >
                <div className="bg-white px-3 py-2 rounded shadow-md border flex items-center gap-2 min-w-[150px]">
                  <Image
                    src={AzureLogo}
                    alt="Azure Logo"
                    width={24}
        ...
        {/* <div className="absolute top-175 -left-8 max-md:hidden">
          <MapMarkerIcon
            ...
            style={{ width: 39, height: 39, position: "absolute", left: 326, top: 50 }}
          />
        </div> */}
      </div>
    </div>
