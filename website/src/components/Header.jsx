...
export const Header = () => {
  ...
  return (
    <header className="w-full bg-white flex justify-between flex-col md:flex-row px-6 py-4 sm:px-10 lg:px-[100px] px-[clamp(15px,6.5vw,100px)] md:py-[16px] text-sm font-light">
