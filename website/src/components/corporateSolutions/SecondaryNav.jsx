...
export function SecondaryNav() {
  return (
    <nav className="flex flex-wrap gap-10 self-stretch px-20 py-5 mt-5 w-full text-xs font-light text-white bg-black border-b border-white border-opacity-10 max-md:px-5 max-md:max-w-full">
