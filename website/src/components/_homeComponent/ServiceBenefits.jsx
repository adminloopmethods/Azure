...
export const ServiceBenefits = () => {
  return (
    <section className="flex flex-col items-center justify-center w-full px-16 py-24 text-center bg-zinc-100 max-xl:px-10 max-lg:px-6 max-md:px-4 max-md:py-16">
