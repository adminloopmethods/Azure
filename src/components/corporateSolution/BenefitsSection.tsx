...
export function BenefitsSection() {
  return (
    <section className="flex flex-col justify-center items-center self-stretch px-16 py-24 mt-24 w-full text-center bg-zinc-100 max-md:px-5 max-md:mt-10 max-md:max-w-full">
